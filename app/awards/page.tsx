const awards = [
  {
    title: "Best Paper Award of IHRAA",
    desc: "The Best Paper Award will be given to the most outstanding research paper presented at the IHRAA conference. The organizing committee, with input from the scientific review panel, will select the winner based on several factors: relevance to the conference’s themes, the depth and quality of research, and the significance of the findings. Both in-person and virtual paper submissions are eligible for this prestigious recognition. The recipient of the Best Paper Award will receive a Gold Medal and a Certificate of Achievement during the award ceremony. The decision made by the IHRAA organizing committee is final.",
  },
  {
    title: "Best Presentation Award of IHRAA",
  ...
  return (
    <div className='w-full min-h-screen max-w-6xl mx-auto px-4 pb-12 pt-6 dark:text-gray-400'>
      ...
      <p className='mt-8'>
        ...
        and human rights practices, embodying IHRAA&apos;s mission of empowering
